...
<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image:url('../assets/uploads/avatar/<?=Session::get('user')['avatar']?>')"></div>
						<i class="symbol-badge bg-success"></i>
					</div>
					<div class="d-flex flex-column">
						<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?=Session::get('user')['username']?></a>
						<div class="text-muted mt-1"><?=(Session::get('user')['role']==3) ? 'Admin' : 'Staff'?></div>
						<div class="navi mt-2">
		...
		<script src="assets/js/scripts.bundle.js?t=<?=randomStr()?>"></script>
		...
		<script src="assets/js/pages/my-script.js?t=<?=randomStr()?>"></script>
		<!--end::custom Scripts-->
	</body>
	<!--end::Body-->
</html>