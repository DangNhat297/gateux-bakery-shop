			...
			<div class="col-xl-3">
				...
				<div class="card card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url(assets/media/svg/shapes/abstract-1.svg)">
					...
					<div class="card-body">
						...
						<span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block"><?= DB::rowCount("SELECT * FROM category") ?></span>
			...
			<div class="col-xl-3">
				...
				<div class="card card-custom bg-info card-stretch gutter-b">
					...
					<div class="card-body">
						...
						<span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block"><?= DB::rowCount("SELECT * FROM product") ?></span>
						<span class="font-weight-bold text-white font-size-sm">Product</span>
					</div>
					<!--end::Body-->
				</div>
			</div>
			<div class="col-xl-3">
				...
				<div class="card card-custom bg-dark card-stretch gutter-b">
					...
					<div class="card-body">
						...
						<span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 text-hover-primary d-block"><?= DB::rowCount("SELECT * FROM review WHERE review_rating is not null") ?></span>
						<span class="font-weight-bold text-white font-size-sm">Review</span>
					</div>
					<!--end::Body-->
				</div>
				<!--end::Body-->
			...
			<div class="col-xl-3">
				...
				<div class="card card-custom bg-danger card-stretch gutter-b">
					...
					<div class="card-body">
						...
						<span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block"><?= DB::rowCount("SELECT * FROM users") ?></span>
						<span class="font-weight-bold text-white font-size-sm">User</span>
					</div>
					<!--end::Body-->
				</div>
				<!--end::Stats Widget 31-->
			...
			<div class="col-xl-4">
				...
				<div class="card card-custom bg-warning card-stretch gutter-b">
					...
					<div class="card-body">
						...
						<span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block"><?= DB::rowCount("SELECT * FROM blog") ?></span>
						<span class="font-weight-bold text-white font-size-sm">Post</span>
					</div>
					<!--end::Body-->
				</div>
				<!--end::Stats Widget 31-->
			...
			<div class="col-xl-4">
				...
				<div class="card card-custom bg-success card-stretch gutter-b">
					...
					<div class="card-body">
						...
						<span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block"><?= DB::rowCount("SELECT * FROM orders") ?></span>
						<span class="font-weight-bold text-white font-size-sm">Order</span>
					</div>
					<!--end::Body-->
				</div>
				<!--end::Stats Widget 31-->
			...
			<div class="col-xl-4">
				...
				<div class="card card-custom bg-primary card-stretch gutter-b">
					...
					<div class="card-body">
						...
						<span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block"><?= product_price(DB::fetch("SELECT SUM(order_detail.product_quantity*order_detail.product_price) as revenue FROM order_detail, orders WHERE orders.order_id = order_detail.order_id AND orders.order_status = 3")['revenue']) ?></span>
						<span class="font-weight-bold text-white font-size-sm">Revenue</span>
					</div>
					<!--end::Body-->
				</div>
				<!--end::Stats Widget 31-->
				...
				<div class="card card-custom gutter-b">
					<div class="card-header flex-wrap flex-column border-0 pt-6 pb-0">
						<div class="card-title">
							<h3 class="card-label">Analytics
								<span class="d-block text-muted pt-2 font-size-sm">Top 5 Most View Products</span>
							</h3>
						</div>
						<div class="card-body">
							<!--begin: Datatable-->
							<div class="datatable datatable-default datatable-bordered datatable-loaded">
								<table class="datatable-bordered datatable-head-custom datatable-table" style="display: block;">
									<thead class="datatable-head">
										<tr class="datatable-row" style="left: 0px;">
											<th class="datatable-cell" style="width: 10%"><span>No.</span></th>
									...
									<tbody style="" class="datatable-body">
										<?php $sql = "SELECT * FROM product ORDER BY product_view DESC LIMIT 0,5";
										$topViewProduct = DB::fetchAll($sql);
										$i = 1;
										foreach ($topViewProduct as $product) :
										?>
											<tr class="datatable-row">
												<td class="datatable-cell" style="width: 10%"><span><?= $i;
																									$i++ ?></span></td>
												<td class="datatable-cell" style="flex-grow:1"><span><?= $product['product_name'] ?></span></td>
												<td class="datatable-cell" style="width: 10%"><span><span class="label font-weight-bold label-lg label-light-primary label-inline"><?= $product['product_view'] ?></span></span></td>
											</tr>
										<?php endforeach ?>
									</tbody>
								</table>
			...
			<div class="col-md-6">
				<div class="flex-row-fluid" id="kt_chat_content">
					...
					<div class="card card-custom">
						...
						<div class="card-body">
							<!--begin::Scroll-->
							<div class="scroll scroll-pull ps ps--active-y" data-scroll="true" data-mobile-height="250" style="height: 206px; overflow: hidden;">
								<!--begin::Messages-->
								<div class="messages">
									
								</div>
								<!--end::Messages-->
							<div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 206px; right: -2px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 41px;"></div></div></div>
							<!--end::Scroll-->
						</div>
						<!--end::Body-->
						<!--begin::Footer-->
						<div class="card-footer align-items-center">
							<form id="submit-chat">
								<!--begin::Compose-->
								<textarea class="form-control border-0 p-0" name="message" rows="2" placeholder="Type a message"></textarea>
...
<script>
	$(document).ready(function(){
		function fetchDataChat(){
			$.ajax({
				...
				success		: function(data){
					if(data.length > 0){
						$('#kt_chat_content').find('.messages').html(data)
					} else {
						$('#kt_chat_content').find('.messages').html('<p style="text-align:center">Chat is empty</p>')
					}
				}
			})
		}
		fetchDataChat()
		setTimeout(()=>{
			$('#kt_chat_content').find('.scroll').animate({ scrollTop: $('#kt_chat_content').find('.scroll').prop('scrollHeight')}, 'fast')
		},100)
		setInterval(fetchDataChat,1000)
		$('#submit-chat').submit(function(e){
			e.preventDefault()
			$this = $(this)
			...
			$.ajax({
				...
				type		: 'POST',
				dataType	: 'json',
				data		: {action: 'add-chat', message: $message},
				beforeSend	: function(){
					$this.find('button[type="submit"]').addClass('spinner spinner-white spinner-right').prop('disabled', true)
				},
				success		: function(data){
					setTimeout(()=>{
						...
						$this.find('button[type="submit"]').removeClass('spinner spinner-white spinner-right').prop('disabled', false)
					},200)
				}
			})
		})
